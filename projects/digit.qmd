...
description: This project explores the use of k-approximation method for handwritten digit classification"
date: 2023-12-11
...
This approach captures important information from the data, enabling each digit image to be represented in a reduced form. The focus is on the **k** left singular vectors **U**, which capture the key features of the images. The rank-k approximation is as follows

$$
k\text{-Approximation} = \text{span}(U_k)
$$
