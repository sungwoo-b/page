...
description: "This project provides visual information on sea ice concentration and compares it with animal telemetry data to demonstrate the relationship between them."
date: 2024-09-10
...
Sea Ice Concentration data is obtained from the NOAA Polar Watch ERDDAP Data Server and NetCDF format data was used in this project. This data includes time, coordinates, and Sea Ice Concentration data.
...
The Polar Stereographic Projection is a projection method centered on the polar regions, and in this case, it is centered on the South Pole.
...
The blue areas in the map above represent Sea Ice Concentration, the concentration levels can be referenced using the color bar.
...
ax.set_title('Penguin Travel Direction by Date (ArgosQuality 3 & 2)')
fig.colorbar(cs, ax=ax, location='right', shrink=0.8)
plt.show()
