---
title: "Sea Ice Concentration and Penguin Telemetry"
subtitle: "Geospatial Data Analysis"
description: "This is the part of tutorial that introduces the use of geospatial data."
date: 2024-03-07
...
fig, axs = plt.subplots(2, 2, figsize=(8, 8))  # Adjusted figsize for 2x2
...
penguin_AB = penguin[(penguin['ArgosQuality'] == 'A') | (penguin['ArgosQuality'] == 'B')]
penguin_AB_avg = penguin_AB.groupby(['BirdId', 'DateGMT']).agg({'Latitude': 'mean', 'Longitude': 'mean'}).reset_index()

# Add Color
unique_birds = penguin_AB_avg['BirdId'].unique()
...
for bird_id, group in penguin_AB_avg.groupby('BirdId'):
...
ax.set_title('Penguin Travel Direction by Date (ArgosQuality A & B)')
fig.colorbar(cs, ax=ax, location='right', shrink=0.8)
plt.show()
